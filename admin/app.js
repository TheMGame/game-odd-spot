...
function updatePuzzleTimeLimit(value){const p=state.level.puzzle,next=Math.max(0,Math.min(3600,Math.floor(Number(value)||0)));if(next>0)p.time_limit_seconds=next;else delete p.time_limit_seconds;markDirty();renderEditor()}
